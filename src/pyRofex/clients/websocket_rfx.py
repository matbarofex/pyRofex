...
class WebSocketClient():
    ...
    def send_order(self, ticker, size, side,
        ...
        message = messages.SEND_ORDER.format(ticker=ticker, price=price, size=size, account=account, side=side.value.upper(), all_or_none = all_or_none)
